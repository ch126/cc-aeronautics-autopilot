...
C.PID_ATT_PITCH  = { kp=25.0, ki=0.0,  kd=6.0,  dmax=45, imax=0,  omax=120 }
C.PID_ATT_ROLL   = { kp=25.0, ki=0.0,  kd=6.0,  dmax=45, imax=0,  omax=120 }
C.PID_ATT_YAW    = { kp=18.0, ki=0.1,  kd=2.5,  dmax=25, imax=30, omax=90  }
